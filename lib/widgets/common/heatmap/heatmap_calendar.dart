...
class HeatMapCalendar extends StatefulWidget {
  ...
  // The text color of month labels.
  ...
  Widget _header() {
    return Row(
      ...
      children: <Widget>[
        ...
        CupertinoButton(
          child: const Icon(CupertinoIcons.chevron_back, size: 14),
          onPressed: () => changeMonth(-1),
        ),

        // Text which shows the current year and month
        Text(
          '${DateUtil.monthLabel[_currentDate?.month ?? 0]} ${(_currentDate?.year).toString()}',
          style: TextStyle(
            color: widget.monthTextColor ?? const Color(0xFF758EA1),
        ...
        // Next month button.
        CupertinoButton(
          child: const Icon(CupertinoIcons.chevron_forward, size: 14),
          onPressed: () => changeMonth(1),
        ),
      ],
    );
