...
class PopupDictionary {
  ...
  static Future<void> warmUp() async {
    await getDictionarySettings();
  }

  // loads settings to cache
  static Future<List<dynamic>> getDictionarySettings() async {
    return await Future.wait([
      ...
      SettingsManager().getLookupLanguage(),
    ]);
  }
  ...
  Future<void> showVocabularyList({
    ...
    List<dynamic> popupDictionarySettings = await getDictionarySettings();
    PopupDictionaryThemeData popupDictionaryThemeData =
        PopupDictionaryThemeData(
          popupDictionaryTheme: popupDictionarySettings[0],
        );
    bool enableSlideAnimation = Platform.isIOS
        ? popupDictionarySettings[1]
        : false;
          ...
          child: Container(
            ...
            child: HeroControllerScope.none(
              child: CupertinoTabScaffold(
                backgroundColor: popupDictionaryThemeData.getColor(
                            ...
                            switch (tabIndex) {
                              case 0:
                                return PopupDictionaryContent(
                                  ...
                                  popupDictionaryThemeData:
                                      popupDictionaryThemeData,
                                  enableLookupHighlight: enableLookupHighlight,
