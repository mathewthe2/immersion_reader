      ...
      case PitchAccentDisplayStyle.graph:
        {
          return SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...vocabulary.pitchValues.map(
                  (String pitchValue) => SvgPicture.string(
      ...
      case PitchAccentDisplayStyle.number:
        {
          return Padding(
            padding: EdgeInsets.only(
              top: vocabulary.reading!.isEmpty ? 0 : 20,
            ), // adjust for furigana height
            child: Text(
              vocabulary.pitchValues.map((value) => '[$value]').join(', '),
              style: TextStyle(
                color: themeData.getColor(DictionaryColor.pitchNumberColor),
              ),
            ),
          );
        }
